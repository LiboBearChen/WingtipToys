...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-ox8bj1438685_api1.business.example.com";
    private string APIPassword = "F88J3WMX624HGAS7";
    private string APISignature = "ArH5sKzeLhwRH46YqCMeWMtHi1b9AgPTQJDpX8zwMIiEVN9wfkr9T90q";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44342/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44342/Checkout/CheckoutCancel.aspx";
